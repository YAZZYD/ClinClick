...
<html lang="en">
    ...
    <body>
	          ...
	          <h2>Clin<span class="danger">Click</span></h2>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <form method="GET" action="{{route('maint.rechercher')}}" class="form-inline my-2 my-lg-0">
                        @csrf
                        <input type="hidden" id="maint" name="maint" value="{{$maint}}">
        ...
        <li class="nav-item">
		  <form method="GET" action="{{route('afficherPanierMaint')}}">
				@csrf
				<input type="hidden" id="maint" name="maint" value="{{$maint->id}}"/>
    ...
    <div class="container px-4 px-lg-5 my-5">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a href="#" class="nav-link">Category 5</a></li>
        </ul>
    </div>
</nav>
        <!-- Section-->
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="product-content">
                           ...
                           <p>Quantité disponible sur le stocke{{$fournisseur->pivot->qte}}</p>
                            <!-- Product reviews-->
                            <div class="rev">
                             <!-- Product price-->
                    ...
                    <div class="card-footer">
                        ...
                        <form id="addToCartForm" method="POST" action="{{route('ajouterAchatMaint')}}">
                                @csrf
                              <input type="hidden"  value="{{$fournisseur->id}}" name="fournisseur"/>
                              <input type="hidden"  value="{{$produit->id}}" name="produit" />
                              <input type="hidden"  value="{{$maint->id}}" name="maint" />
                              <input type="number" min="1" name="qte" placeholder="entrer la quntité"/>
