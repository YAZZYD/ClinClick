...
<html lang="en">
    ...
    <table>
        ...
        <tr>
            ...
            <td>{{ $total }} DZD</td>
            <td>
                <form class="button-container" method="POST" action="{{ route('supprimerAchatMaint', $achat->id) }}">
                    @csrf
                    @method("DELETE")
    ...
    <form method="POST" action="{{ route('commanderMaint') }}">
        @csrf
        <input type="hidden" id="maint" name="maint" value="{{ $maint->id }}" />
        <button type="submit" class="btn btn-primary">Commander</button>
    </form>
              <a href="/maintenancier/market"> <button type="submit" class="btn btn-primary">Poursuivre l'achat </button></a>

    
    @else
    <p>Votre panier est vide.</p>
    <a href="/maintenancier/market" class="btn btn-primary">Retour au Market</a>
    @endif
    </div>
    </div>
