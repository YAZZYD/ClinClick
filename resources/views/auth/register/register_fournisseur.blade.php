...
<body>
  <div class="signup-form">
    <form action="{{ route('register.fournisseur') }}" method="post" enctype="multipart/form-data">
      <div class="logo">
      ...
      <div class="info-sections">
        ...
        <div class="info-cabinet">
          ...
          <div class="form-group">
            <input type="number" class="form-control" name="tel" name="tel" placeholder="N° téléphone" required="required" value="{{ old('Num-tele') }}">
            @error('tel')
              <span class="error">{{ $message }}</span>
            @enderror
            <br>
            <input type="file" class="form-control" name="file" id="file" placeholder="Fichier" required="required" value="{{ old('file') }}">
            @error('file')
              <span class="error">{{ $message }}</span>
            @enderror
          </div>
