...
<nav class="right">
        <div class="top">
            <button id="menu-btn">
                ...
                <div class="action1">
                    <span class="cart"><a href="{{route('afficherPanierMaint')}}"><ion-icon name="cart-outline"></ion-icon></a></span>
                </div>
                <div class="action2">
                <span class="notification"><a href="{{route('maint.notifications')}}"><ion-icon name="notifications-outline"></ion-icon></a></span>
                </div>
                <div class="profile">
                    <div class="info">
